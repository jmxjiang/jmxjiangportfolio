...
app = Flask(__name__)
text = ['Hello there!', 'Oh, who am I?', 'I am a computer created by someone.', 'Who is that person, you may ask?',
        ...
        'Look at these animations!', 'jmx-jiang has the power to create them!', "They're just so awesome!", 'WOW!',
        ...
        'He builds a variety of things, not just websites.', 'He likes to create interesting websites (like this one).',
